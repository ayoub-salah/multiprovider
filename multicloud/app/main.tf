module "vpc_aws" {
  ...
  vpcs_aws = {
    vpc1 = {address_space = ["192.168.1.0/24"], location  = "East US" },
    vpc2 = {address_space = ["192.168.2.0/24"], location = "East US" },
    vpc3 = {address_space = ["192.168.3.0/24"], location  = "East US" },
  }
}
